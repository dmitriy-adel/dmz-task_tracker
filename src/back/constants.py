VERIFICATION_CODE_EMAIL: str = '''Здравствуйте! Отправили Вам код верификации. Если Вы не взаимодействовали с сервисом DMZ Task Tracker в настоящий момент, никому не сообщайте код верификации. 
Код верификации: {verification_code}

С уважением,
Команда сервиса DMZ Task Tracker'''
                    ...
                    <tr>
                        <td style="padding: 40px 40px 30px 40px; text-align:center; color:#222222;">
                            <h2 style="margin:0 0 20px 0; font-size:20px; font-weight:600;">
                                Если вы запрашивали вход в DMZ Task Tracker,<br>
                            ...
                            <p style="margin:25px 0 0 0; font-size:16px; line-height:1.5; color:#444444;">
                                Если вы не пытались войти в DMZ Task Tracker,<br>
...
С уважением,
Команда поддержки DMZ Task Tracker'''